            ...
            <View style={styles.container}>
                ...
                <ImageBackground source={require('../assets/stars.gif')} style={styles.backgroundImage}>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={() =>
                        ...
                        <Image source={require("../assets/iss_icon.png")} style={styles.routeImage3}></Image>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={() =>
                        ...
                        <Image source={require("../assets/meteor_icon.png")} style={styles.routeImage2}></Image>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.routeCard} onPress={() =>
                        this.props.navigation.navigate("Constellation")
                    }>
                        <Text style={styles.routeText}>Constalation</Text>
                        <Image source={require("../assets/constalation_icon.jpg")} style={styles.routeImage3}></Image>
                    </TouchableOpacity>
                </ImageBackground>
            </View>
        );
